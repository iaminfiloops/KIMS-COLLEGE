...
const products: Product[] = [
  {
    id: 1,
    title: "Krishnanagar Institute of Medical Science",
    description:
      "Krishnanagar Institute of Medical Science is a private medical college located in Krishnanagr, West Bengal..",
    image: bannerKims,
    link: "/aboutUs",
  },
];
...
const CarouselComponentkims: React.FC = () => {
...
export default CarouselComponentkims;
